...
def main(args):
    ...
    for epoch in range(args.epoch):
        ...
        log = open("log3.txt", "a")
        print('Epoch %2d: loss: %10.2f > loss: %5.2f acc: %0.4f ' %(epoch, train_loss, test_loss, test_acc) , file = log)
        print('Epoch %2d: loss: %10.2f > loss: %5.2f acc: %0.4f ' % (epoch, train_loss, test_loss, test_acc))
